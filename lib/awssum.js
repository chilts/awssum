...
function addArrayParam(params, name, value, extra) {
    value = value || [];
...
function addArrayParamSet(params, setName, name, value) {
    value = value || [];
...
AwsSum.prototype.send = function(operation, args, callback) {
    ...
    for ( var argName in operation.args ) {
        ...
        if ( spec.type === 'param' ) {
            ...
            addArrayParam( params, name, args[argName], spec.prefix );
        }
        else if ( spec.type === 'param-array-set' ) {
            addArrayParamSet( params, spec.setName, name, args[argName] );
        }
...
exports.addArrayParam = addArrayParam
