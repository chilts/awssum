...
AwsSum.prototype.send = function(operation, args, callback) {
    ...
    if ( operation.method ) {
        if ( typeof operation.method === 'string' ) {
            ...
            options.method = operation.method.apply(self, [ args ]);
        }
        else {
    ...
    if ( operation.host ) {
        if ( typeof operation.host === 'function' ) {
            options.host = operation.host.apply(self, [ args ]);
        }
    ...
    if ( operation.path ) {
        if ( typeof operation.path === 'function' ) {
            options.path = operation.path.apply(self, [ args ]);
        }
    ...
    if ( operation.body ) {
        if ( typeof operation.body === 'string' ) {
            ...
            options.body = operation.body.apply(self, [ options ]);
        }
        else {
            // since this is a program error, we're gonna throw this one
