...
Amazon.prototype.performNewRequest = function(data, callback) {
    var self = this;
    ...
    if ( _.isUndefined(data.decodeBody) ) {
        data.decodeBody = true;
    }

    self.performRequest(data.action, data.path, data.params, callback);
};
