...
// http://docs.amazonwebservices.com/AmazonS3/latest/API/RESTObjectGETacl.html
S3.prototype.getObjectAcl = function(options, callback) {
    var self = this;
    if ( callback == null ) {
        callback = options;
        options = {};
    ...
    var params = [{ name : 'acl' }];
    self.addParamIfDefined( params, 'versionId', options.VersionId );
...
// http://docs.amazonwebservices.com/AmazonS3/latest/API/RESTObjectGETtorrent.html
S3.prototype.getObjectTorrent = function(options, callback) {
    var self = this;
    if ( callback == null ) {
        callback = options;
        options = {};
