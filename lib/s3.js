    ...
    var req = https.request( reqOptions, function(res) {
        ...
        res.on('end', function() {
            ...
            parser.parseString(xml, _.once(function (err, result) {
                ...
                // each request to Amazon S3 returns two headers, 'x-amz-request-id' and 'x-amz-id-2' and in the case
                // of PutObject we might also get 'x-amz-server-side-encryption' and 'x-amz-version-id', so we should
                // just parse out any of these returned headers.
