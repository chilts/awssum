...
Sqs.prototype.addPermission = function(args, callback) {
    ...
    var path = '/' + this.awsAccountId() + '/' + args.queueName;

    this.performOldRequest('AddPermission', path, params, callback);
};
...
Sqs.prototype.changeMessageVisibility = function(args, callback) {
    ...
    var params = [];
    this.addParam(params, 'ReceiptHandle', args.receiptHandle);
    this.addParam(params, 'VisibilityTimeout', args.visibilityTimeout);
    ...
    this.performOldRequest('ChangeMessageVisibility', path, params, callback);
}
...
Sqs.prototype.changeMessageVisibilityBatch = function(args, callback) {
    ...
    this.performOldRequest('ChangeMessageVisibilityBatch', path, params, callback);
}
...
Sqs.prototype.createQueue = function(args, callback) {
    ...
    this.performOldRequest('CreateQueue', '/', params, callback);
};
...
Sqs.prototype.deleteMessage = function(args, callback) {
    ...
    this.performOldRequest('DeleteMessage', path, params, callback);
}
...
Sqs.prototype.deleteMessageBatch = function(args, callback) {
    ...
    this.performOldRequest('DeleteMessageBatch', path, params, callback);
}
...
Sqs.prototype.deleteQueue = function(args, callback) {
    ...
    this.performOldRequest('DeleteQueue', path, params, callback);
};
...
Sqs.prototype.getQueueAttributes = function(args, callback) {
    ...
    this.performOldRequest('GetQueueAttributes', path, params, callback);
};
...
Sqs.prototype.getQueueUrl = function(args, callback) {
    ...
    var params = [];
    this.addParam(params, 'QueueName', args.queueName);
    this.addParamIfDefined(params, 'QueueOwnerAwsAccountId', args.queueOwnerAwsAccountId);

    // console.log(util.inspect(params, true, null));

    this.performOldRequest('GetQueueUrl', '/', params, callback);
};
...
Sqs.prototype.listQueues = function(args, callback) {
    ...
    this.performOldRequest('ListQueues', '/', params, callback);
};
...
Sqs.prototype.receiveMessage = function(args, callback) {
    ...
    this.addParamIfDefined(params, 'MaxNumberOfMessages', args.maxNumberOfMessages);
    this.addParamIfDefined(params, 'VisibilityTimeout',   args.visibilityTimeout);
    ...
    this.performOldRequest('ReceiveMessage', path, params, callback);
};
...
Sqs.prototype.removePermission = function(args, callback) {
    ...
    this.performOldRequest('RemovePermission', path, params, callback);
};
...
Sqs.prototype.sendMessage = function(args, callback) {
    ...
    var params = [];
    this.addParam(params, 'MessageBody', args.messageBody);
    this.addParamIfDefined(params, 'DelaySeconds', args.delaySeconds);

    // create the path to this queue
    var path = '/' + this.awsAccountId() + '/' + args.queueName;

    this.performOldRequest('SendMessage', path, params, callback);
};
...
Sqs.prototype.sendMessageBatch = function(args, callback) {
    ...
    this.performOldRequest('SendMessageBatch', path, params, callback);
};
...
Sqs.prototype.setQueueAttributes = function(args, callback) {
    ...
    this.performOldRequest('SetQueueAttributes', path, params, callback);
};
