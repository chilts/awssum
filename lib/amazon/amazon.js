...
var US_WEST_2 = 'Oregon';
var EU_WEST_1 = 'Dublin';
var AP_SOUTHEAST_1 = 'Singapore';
var AP_NORTHEAST_1 = 'Tokyo';
var US_GOV_WEST_1 = 'Undisclosed'; // See : http://aws.amazon.com/about-aws/globalinfrastructure/
...
Amazon.prototype.addArrayParam = function(params, name, value, extra) {
    value = value || [];
...
Amazon.prototype.addHeader = function(header, name, value) {
    console.warn('Amazon.addHeader() is DEPRECATED. Use Amazon.setHeader() instead');
    header[name] = value;
}

Amazon.prototype.addHeaderIfDefined = function(header, name, value) {
    console.warn('Amazon.addHeaderIfDefined() is DEPRECATED. Use Amazon.setHeaderIfDefined() instead');
    if ( ! _.isUndefined(value) ) {
        header[name] = value;
    }
}

Amazon.prototype.setHeader = function(header, name, value) {
    header[name] = value;
}

Amazon.prototype.setHeaderIfDefined = function(header, name, value) {
    if ( ! _.isUndefined(value) ) {
        header[name] = value;
    }
}
