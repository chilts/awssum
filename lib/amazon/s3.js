...
S3.prototype.strToSign = function(options, args) {
    ...
    // Add all the other parameters onto the strToSign (Note: ignore the fact that the docs call them 'sub-resources',
    // - that's just confusing. Also, we need all of the parameters, not the things that they call sub-resources!
