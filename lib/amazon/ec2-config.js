...
module.exports = {
    ...
    ModifyInstanceAttribute : {
        ...
        args : {
            Action                                    : required,
            InstanceId                                : required,
            'InstanceType.Value'                      : optionalData,
            'Kernel.Value'                            : optionalData,
            'Ramdisk.Value'                           : optionalData,
            'UserData.Value'                          : optionalData,
            'DisableApiTermination.Value'             : optionalData,
            'InstanceInitiatedShutdownBehavior.Value' : optionalData,
            'BlockMappingDevice.Value'                : optionalData,
            'SourceDestCheck.Value'                   : optionalData,
            GroupId                                   : optionalArray,
