...
CloudFront.prototype.CreateStreamingDistribution = function(args, callback) {
    var self = this;
    if ( callback == null ) {
        callback = args;
        args = {};
    ...
    var operation = operations.CreateStreamingDistribution;
    ...
    var body = data2xml('StreamingDistributionConfig', data);
    // console.log('XML :', body);
...
CloudFront.prototype.PutStreamingDistributionConfig = function(args, callback) {
    var self = this;
    if ( callback == null ) {
        callback = args;
        args = {};
